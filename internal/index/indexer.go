...
func (idx *Indexer) ScanProject(ctx context.Context) error {
	...
	// 1. Pre-check: Verify if fd exists AND is executable for current architecture
	// This avoids "Bad CPU type in executable" errors on mixed arch systems.
	...
	// 2. Use fd for high-speed scanning
	args := []string{
		"--type", "f",
